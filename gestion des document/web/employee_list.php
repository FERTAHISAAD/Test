	...
	if (!empty($firstname) && !empty($lastname) && !empty($company)) {
		...
		if (isset($_FILES['fichier']))
		{
		   ...
		   else
		   {
				...
				{
					$message_up = 'Votre fichier à été attaché avec succès !';
					$pass_file = $nom_fichier;
				}
				else
				{
					$message_up = 'Le fichier n\'a pas pu etre attaché !';
				}
		   }
                ...
                <td align="center" valign="top"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="left" class="title_1"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="50%" align="left" class="title_1">Liste des Employés | <span class="txt_4">Action :</span> <span class="txt_1g"><img src="../image/design/puce_add.png"  width="22" height="22" align="absmiddle" /> <a href="<?php echo $page ?>?show=add">Ajouter un nouveau Employe </a></span></td>
